      ...
      <div className="learn">
        <div className="left">
          <div className="paragraph-Div">
            ...
            <p>
              Unleash your potential with our AI-powered Build program, designed
              to offer personalized, project-based learning in the most
              industry-relevant tech stacks. Gain hands-on experience, validate
      ...
      <div className="learn">
        ...
        <div className="right">
          <div className="paragraph-Div">
            ...
            <p>
              Join a professional community that bridges the gap between
              learning and industry. Collaborate with peers, gain direct
              exposure to real-world projects, and stay ahead with AI-driven
